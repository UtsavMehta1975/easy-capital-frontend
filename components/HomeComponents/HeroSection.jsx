        ...
        <section className="flex flex-col justify-center items-center bg-gray-100 py-6 md:py-16">
            <div className="container mx-auto px-4 md:px-0">
                <div className="w-full text-center md:text-left p-4 md:p-0 flex flex-col items-center md:items-start md:flex-row md:justify-between">
                    <div className="relative flex flex-col items-center md:items-start md:w-1/2 md:self-center">
                        ...
                        <div className="flex flex-col items-center md:relative md:mt-1 md:left-20">
                            <Link href="/apply">
                                <button className="px-5 py-2 mb-2 text-sm font-medium leading-5 text-white capitalize bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none">
